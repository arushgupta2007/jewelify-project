...
u_shp = np.load(f"{dirpath}/train.configs/u_shp_small.npy")
u_exp = np.load(f"{dirpath}/train.configs/u_exp_small.npy")
w_shp = np.load(f"{dirpath}/train.configs/w_shp_small.npy")
w_exp = np.load(f"{dirpath}/train.configs/w_exp_small.npy")
